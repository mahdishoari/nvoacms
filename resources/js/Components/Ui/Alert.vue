<template>
    ...
    <div v-if="type === 'error'" id="alert-2"
    ...
    <div v-if="type === 'success'" id="alert-3"
    ...
    <div v-else id="alert-5" class="flex items-center p-4 rounded-lg bg-gray-50 dark:bg-gray-800" role="alert">
